...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    ("GST_ELEMENT_FACTORY_TYPE_DECODABLE", "353"),
    ...
    ("GST_PAD_UNKNOWN", "0"),
    ("GST_PARAM_CONTROLLABLE", "2"),
    ("GST_PARAM_MUTABLE_PAUSED", "8"),
    ("GST_PARAM_MUTABLE_PLAYING", "16"),
    ("GST_PARAM_MUTABLE_READY", "4"),
    ("GST_PARAM_USER_SHIFT", "256"),
