...
bitflags! {
    ...
    pub struct GstAllocatorFlags: c_uint {
        const CUSTOM_ALLOC = 16;
        const LAST = 1048576;
    }
}
pub const GST_ALLOCATOR_FLAG_CUSTOM_ALLOC: GstAllocatorFlags = GstAllocatorFlags::CUSTOM_ALLOC;
pub const GST_ALLOCATOR_FLAG_LAST: GstAllocatorFlags = GstAllocatorFlags::LAST;
...
pub const GST_BIN_FLAG_NO_RESYNC: GstBinFlags = GstBinFlags::NO_RESYNC;
pub const GST_BIN_FLAG_STREAMS_AWARE: GstBinFlags = GstBinFlags::STREAMS_AWARE;
pub const GST_BIN_FLAG_LAST: GstBinFlags = GstBinFlags::LAST;
...
pub const GST_BUFFER_COPY_NONE: GstBufferCopyFlags = GstBufferCopyFlags::NONE;
pub const GST_BUFFER_COPY_FLAGS: GstBufferCopyFlags = GstBufferCopyFlags::FLAGS;
pub const GST_BUFFER_COPY_TIMESTAMPS: GstBufferCopyFlags = GstBufferCopyFlags::TIMESTAMPS;
pub const GST_BUFFER_COPY_META: GstBufferCopyFlags = GstBufferCopyFlags::META;
pub const GST_BUFFER_COPY_MEMORY: GstBufferCopyFlags = GstBufferCopyFlags::MEMORY;
pub const GST_BUFFER_COPY_MERGE: GstBufferCopyFlags = GstBufferCopyFlags::MERGE;
pub const GST_BUFFER_COPY_DEEP: GstBufferCopyFlags = GstBufferCopyFlags::DEEP;
...
pub const GST_BUFFER_FLAG_LIVE: GstBufferFlags = GstBufferFlags::LIVE;
pub const GST_BUFFER_FLAG_DECODE_ONLY: GstBufferFlags = GstBufferFlags::DECODE_ONLY;
pub const GST_BUFFER_FLAG_DISCONT: GstBufferFlags = GstBufferFlags::DISCONT;
pub const GST_BUFFER_FLAG_RESYNC: GstBufferFlags = GstBufferFlags::RESYNC;
pub const GST_BUFFER_FLAG_CORRUPTED: GstBufferFlags = GstBufferFlags::CORRUPTED;
pub const GST_BUFFER_FLAG_MARKER: GstBufferFlags = GstBufferFlags::MARKER;
pub const GST_BUFFER_FLAG_HEADER: GstBufferFlags = GstBufferFlags::HEADER;
pub const GST_BUFFER_FLAG_GAP: GstBufferFlags = GstBufferFlags::GAP;
pub const GST_BUFFER_FLAG_DROPPABLE: GstBufferFlags = GstBufferFlags::DROPPABLE;
pub const GST_BUFFER_FLAG_DELTA_UNIT: GstBufferFlags = GstBufferFlags::DELTA_UNIT;
pub const GST_BUFFER_FLAG_TAG_MEMORY: GstBufferFlags = GstBufferFlags::TAG_MEMORY;
pub const GST_BUFFER_FLAG_SYNC_AFTER: GstBufferFlags = GstBufferFlags::SYNC_AFTER;
pub const GST_BUFFER_FLAG_NON_DROPPABLE: GstBufferFlags = GstBufferFlags::NON_DROPPABLE;
pub const GST_BUFFER_FLAG_LAST: GstBufferFlags = GstBufferFlags::LAST;
...
pub const GST_BUFFER_POOL_ACQUIRE_FLAG_NONE: GstBufferPoolAcquireFlags = GstBufferPoolAcquireFlags::NONE;
pub const GST_BUFFER_POOL_ACQUIRE_FLAG_KEY_UNIT: GstBufferPoolAcquireFlags = GstBufferPoolAcquireFlags::KEY_UNIT;
pub const GST_BUFFER_POOL_ACQUIRE_FLAG_DONTWAIT: GstBufferPoolAcquireFlags = GstBufferPoolAcquireFlags::DONTWAIT;
pub const GST_BUFFER_POOL_ACQUIRE_FLAG_DISCONT: GstBufferPoolAcquireFlags = GstBufferPoolAcquireFlags::DISCONT;
pub const GST_BUFFER_POOL_ACQUIRE_FLAG_LAST: GstBufferPoolAcquireFlags = GstBufferPoolAcquireFlags::LAST;
...
pub const GST_BUS_FLUSHING: GstBusFlags = GstBusFlags::FLUSHING;
pub const GST_BUS_FLAG_LAST: GstBusFlags = GstBusFlags::FLAG_LAST;
...
pub const GST_CAPS_FLAG_ANY: GstCapsFlags = GstCapsFlags::ANY;
...
pub const GST_CLOCK_FLAG_CAN_DO_SINGLE_SYNC: GstClockFlags = GstClockFlags::CAN_DO_SINGLE_SYNC;
pub const GST_CLOCK_FLAG_CAN_DO_SINGLE_ASYNC: GstClockFlags = GstClockFlags::CAN_DO_SINGLE_ASYNC;
pub const GST_CLOCK_FLAG_CAN_DO_PERIODIC_SYNC: GstClockFlags = GstClockFlags::CAN_DO_PERIODIC_SYNC;
pub const GST_CLOCK_FLAG_CAN_DO_PERIODIC_ASYNC: GstClockFlags = GstClockFlags::CAN_DO_PERIODIC_ASYNC;
pub const GST_CLOCK_FLAG_CAN_SET_RESOLUTION: GstClockFlags = GstClockFlags::CAN_SET_RESOLUTION;
pub const GST_CLOCK_FLAG_CAN_SET_MASTER: GstClockFlags = GstClockFlags::CAN_SET_MASTER;
pub const GST_CLOCK_FLAG_NEEDS_STARTUP_SYNC: GstClockFlags = GstClockFlags::NEEDS_STARTUP_SYNC;
pub const GST_CLOCK_FLAG_LAST: GstClockFlags = GstClockFlags::LAST;
...
pub const GST_DEBUG_FG_BLACK: GstDebugColorFlags = GstDebugColorFlags::BG_BLACK;
pub const GST_DEBUG_FG_RED: GstDebugColorFlags = GstDebugColorFlags::FG_RED;
pub const GST_DEBUG_FG_GREEN: GstDebugColorFlags = GstDebugColorFlags::FG_GREEN;
pub const GST_DEBUG_FG_YELLOW: GstDebugColorFlags = GstDebugColorFlags::FG_YELLOW;
pub const GST_DEBUG_FG_BLUE: GstDebugColorFlags = GstDebugColorFlags::FG_BLUE;
pub const GST_DEBUG_FG_MAGENTA: GstDebugColorFlags = GstDebugColorFlags::FG_MAGENTA;
pub const GST_DEBUG_FG_CYAN: GstDebugColorFlags = GstDebugColorFlags::FG_CYAN;
pub const GST_DEBUG_FG_WHITE: GstDebugColorFlags = GstDebugColorFlags::FG_WHITE;
pub const GST_DEBUG_BG_BLACK: GstDebugColorFlags = GstDebugColorFlags::BG_BLACK;
pub const GST_DEBUG_BG_RED: GstDebugColorFlags = GstDebugColorFlags::BG_RED;
pub const GST_DEBUG_BG_GREEN: GstDebugColorFlags = GstDebugColorFlags::BG_GREEN;
pub const GST_DEBUG_BG_YELLOW: GstDebugColorFlags = GstDebugColorFlags::BG_YELLOW;
pub const GST_DEBUG_BG_BLUE: GstDebugColorFlags = GstDebugColorFlags::BG_BLUE;
pub const GST_DEBUG_BG_MAGENTA: GstDebugColorFlags = GstDebugColorFlags::BG_MAGENTA;
pub const GST_DEBUG_BG_CYAN: GstDebugColorFlags = GstDebugColorFlags::BG_CYAN;
pub const GST_DEBUG_BG_WHITE: GstDebugColorFlags = GstDebugColorFlags::BG_WHITE;
...
pub const GST_DEBUG_GRAPH_SHOW_MEDIA_TYPE: GstDebugGraphDetails = GstDebugGraphDetails::MEDIA_TYPE;
pub const GST_DEBUG_GRAPH_SHOW_CAPS_DETAILS: GstDebugGraphDetails = GstDebugGraphDetails::CAPS_DETAILS;
pub const GST_DEBUG_GRAPH_SHOW_NON_DEFAULT_PARAMS: GstDebugGraphDetails = GstDebugGraphDetails::NON_DEFAULT_PARAMS;
pub const GST_DEBUG_GRAPH_SHOW_STATES: GstDebugGraphDetails = GstDebugGraphDetails::STATES;
pub const GST_DEBUG_GRAPH_SHOW_FULL_PARAMS: GstDebugGraphDetails = GstDebugGraphDetails::FULL_PARAMS;
pub const GST_DEBUG_GRAPH_SHOW_ALL: GstDebugGraphDetails = GstDebugGraphDetails::ALL;
pub const GST_DEBUG_GRAPH_SHOW_VERBOSE: GstDebugGraphDetails = GstDebugGraphDetails::VERBOSE;
...
pub const GST_ELEMENT_FLAG_LOCKED_STATE: GstElementFlags = GstElementFlags::LOCKED_STATE;
pub const GST_ELEMENT_FLAG_SINK: GstElementFlags = GstElementFlags::SINK;
pub const GST_ELEMENT_FLAG_SOURCE: GstElementFlags = GstElementFlags::SOURCE;
pub const GST_ELEMENT_FLAG_PROVIDE_CLOCK: GstElementFlags = GstElementFlags::PROVIDE_CLOCK;
pub const GST_ELEMENT_FLAG_REQUIRE_CLOCK: GstElementFlags = GstElementFlags::REQUIRE_CLOCK;
pub const GST_ELEMENT_FLAG_INDEXABLE: GstElementFlags = GstElementFlags::INDEXABLE;
pub const GST_ELEMENT_FLAG_LAST: GstElementFlags = GstElementFlags::LAST;
...
pub const GST_EVENT_TYPE_UPSTREAM: GstEventTypeFlags = GstEventTypeFlags::UPSTREAM;
pub const GST_EVENT_TYPE_DOWNSTREAM: GstEventTypeFlags = GstEventTypeFlags::DOWNSTREAM;
pub const GST_EVENT_TYPE_SERIALIZED: GstEventTypeFlags = GstEventTypeFlags::SERIALIZED;
pub const GST_EVENT_TYPE_STICKY: GstEventTypeFlags = GstEventTypeFlags::STICKY;
pub const GST_EVENT_TYPE_STICKY_MULTI: GstEventTypeFlags = GstEventTypeFlags::STICKY_MULTI;
...
pub const GST_LOCK_FLAG_READ: GstLockFlags = GstLockFlags::READ;
pub const GST_LOCK_FLAG_WRITE: GstLockFlags = GstLockFlags::WRITE;
pub const GST_LOCK_FLAG_EXCLUSIVE: GstLockFlags = GstLockFlags::EXCLUSIVE;
pub const GST_LOCK_FLAG_LAST: GstLockFlags = GstLockFlags::LAST;
...
bitflags! {
    ...
    pub struct GstMapFlags: c_uint {
        const READ = 1;
        const WRITE = 2;
        const FLAG_LAST = 65536;
    }
}
pub const GST_MAP_READ: GstMapFlags = GstMapFlags::READ;
pub const GST_MAP_WRITE: GstMapFlags = GstMapFlags::WRITE;
...
pub const GST_MEMORY_FLAG_READONLY: GstMemoryFlags = GstMemoryFlags::READONLY;
pub const GST_MEMORY_FLAG_NO_SHARE: GstMemoryFlags = GstMemoryFlags::NO_SHARE;
pub const GST_MEMORY_FLAG_ZERO_PREFIXED: GstMemoryFlags = GstMemoryFlags::ZERO_PREFIXED;
pub const GST_MEMORY_FLAG_ZERO_PADDED: GstMemoryFlags = GstMemoryFlags::ZERO_PADDED;
pub const GST_MEMORY_FLAG_PHYSICALLY_CONTIGUOUS: GstMemoryFlags = GstMemoryFlags::PHYSICALLY_CONTIGUOUS;
pub const GST_MEMORY_FLAG_NOT_MAPPABLE: GstMemoryFlags = GstMemoryFlags::NOT_MAPPABLE;
pub const GST_MEMORY_FLAG_LAST: GstMemoryFlags = GstMemoryFlags::LAST;
...
bitflags! {
    ...
    pub struct GstMessageType: c_uint {
        ...
        const TAG = 16;
        const BUFFERING = 32;
        const STATE_CHANGED = 64;
        const STATE_DIRTY = 128;
        const STEP_DONE = 256;
        const CLOCK_PROVIDE = 512;
        const CLOCK_LOST = 1024;
        const NEW_CLOCK = 2048;
        const STRUCTURE_CHANGE = 4096;
        const STREAM_STATUS = 8192;
        const APPLICATION = 16384;
        const ELEMENT = 32768;
        const SEGMENT_START = 65536;
        const SEGMENT_DONE = 131072;
        const DURATION_CHANGED = 262144;
        const LATENCY = 524288;
        const ASYNC_START = 1048576;
        const ASYNC_DONE = 2097152;
        const REQUEST_STATE = 4194304;
        const STEP_START = 8388608;
        const QOS = 16777216;
        const PROGRESS = 33554432;
        const TOC = 67108864;
        const RESET_TIME = 134217728;
        const STREAM_START = 268435456;
        const NEED_CONTEXT = 536870912;
        const HAVE_CONTEXT = 1073741824;
        const EXTENDED = 2147483648;
        const DEVICE_ADDED = 2147483649;
        const DEVICE_REMOVED = 2147483650;
        const PROPERTY_NOTIFY = 2147483651;
        const STREAM_COLLECTION = 2147483652;
        const STREAMS_SELECTED = 2147483653;
        const REDIRECT = 2147483654;
        const ANY = 4294967295;
    }
}
pub const GST_MESSAGE_UNKNOWN: GstMessageType = GstMessageType::UNKNOWN;
pub const GST_MESSAGE_EOS: GstMessageType = GstMessageType::EOS;
pub const GST_MESSAGE_ERROR: GstMessageType = GstMessageType::ERROR;
pub const GST_MESSAGE_WARNING: GstMessageType = GstMessageType::WARNING;
pub const GST_MESSAGE_INFO: GstMessageType = GstMessageType::INFO;
pub const GST_MESSAGE_TAG: GstMessageType = GstMessageType::TAG;
pub const GST_MESSAGE_BUFFERING: GstMessageType = GstMessageType::BUFFERING;
pub const GST_MESSAGE_STATE_CHANGED: GstMessageType = GstMessageType::STATE_CHANGED;
pub const GST_MESSAGE_STATE_DIRTY: GstMessageType = GstMessageType::STATE_DIRTY;
pub const GST_MESSAGE_STEP_DONE: GstMessageType = GstMessageType::STEP_DONE;
pub const GST_MESSAGE_CLOCK_PROVIDE: GstMessageType = GstMessageType::CLOCK_PROVIDE;
pub const GST_MESSAGE_CLOCK_LOST: GstMessageType = GstMessageType::CLOCK_LOST;
pub const GST_MESSAGE_NEW_CLOCK: GstMessageType = GstMessageType::NEW_CLOCK;
pub const GST_MESSAGE_STRUCTURE_CHANGE: GstMessageType = GstMessageType::STRUCTURE_CHANGE;
pub const GST_MESSAGE_STREAM_STATUS: GstMessageType = GstMessageType::STREAM_STATUS;
pub const GST_MESSAGE_APPLICATION: GstMessageType = GstMessageType::APPLICATION;
pub const GST_MESSAGE_ELEMENT: GstMessageType = GstMessageType::ELEMENT;
pub const GST_MESSAGE_SEGMENT_START: GstMessageType = GstMessageType::SEGMENT_START;
pub const GST_MESSAGE_SEGMENT_DONE: GstMessageType = GstMessageType::SEGMENT_DONE;
pub const GST_MESSAGE_DURATION_CHANGED: GstMessageType = GstMessageType::DURATION_CHANGED;
pub const GST_MESSAGE_LATENCY: GstMessageType = GstMessageType::LATENCY;
pub const GST_MESSAGE_ASYNC_START: GstMessageType = GstMessageType::ASYNC_START;
pub const GST_MESSAGE_ASYNC_DONE: GstMessageType = GstMessageType::ASYNC_DONE;
pub const GST_MESSAGE_REQUEST_STATE: GstMessageType = GstMessageType::REQUEST_STATE;
pub const GST_MESSAGE_STEP_START: GstMessageType = GstMessageType::STEP_START;
pub const GST_MESSAGE_QOS: GstMessageType = GstMessageType::QOS;
pub const GST_MESSAGE_PROGRESS: GstMessageType = GstMessageType::PROGRESS;
pub const GST_MESSAGE_TOC: GstMessageType = GstMessageType::TOC;
pub const GST_MESSAGE_RESET_TIME: GstMessageType = GstMessageType::RESET_TIME;
pub const GST_MESSAGE_STREAM_START: GstMessageType = GstMessageType::STREAM_START;
pub const GST_MESSAGE_NEED_CONTEXT: GstMessageType = GstMessageType::NEED_CONTEXT;
pub const GST_MESSAGE_HAVE_CONTEXT: GstMessageType = GstMessageType::HAVE_CONTEXT;
pub const GST_MESSAGE_EXTENDED: GstMessageType = GstMessageType::EXTENDED;
pub const GST_MESSAGE_DEVICE_ADDED: GstMessageType = GstMessageType::DEVICE_ADDED;
pub const GST_MESSAGE_DEVICE_REMOVED: GstMessageType = GstMessageType::DEVICE_REMOVED;
pub const GST_MESSAGE_PROPERTY_NOTIFY: GstMessageType = GstMessageType::PROPERTY_NOTIFY;
pub const GST_MESSAGE_STREAM_COLLECTION: GstMessageType = GstMessageType::STREAM_COLLECTION;
pub const GST_MESSAGE_STREAMS_SELECTED: GstMessageType = GstMessageType::STREAMS_SELECTED;
pub const GST_MESSAGE_REDIRECT: GstMessageType = GstMessageType::REDIRECT;
pub const GST_MESSAGE_ANY: GstMessageType = GstMessageType::ANY;
...
pub const GST_META_FLAG_NONE: GstMetaFlags = GstMetaFlags::NONE;
pub const GST_META_FLAG_READONLY: GstMetaFlags = GstMetaFlags::READONLY;
pub const GST_META_FLAG_POOLED: GstMetaFlags = GstMetaFlags::POOLED;
pub const GST_META_FLAG_LOCKED: GstMetaFlags = GstMetaFlags::LOCKED;
pub const GST_META_FLAG_LAST: GstMetaFlags = GstMetaFlags::LAST;

bitflags! {
    #[repr(C)]
    pub struct GstMiniObjectFlags: c_uint {
        const LOCKABLE = 1;
        const LOCK_READONLY = 2;
        const MAY_BE_LEAKED = 4;
        const LAST = 16;
    }
}
pub const GST_MINI_OBJECT_FLAG_LOCKABLE: GstMiniObjectFlags = GstMiniObjectFlags::LOCKABLE;
pub const GST_MINI_OBJECT_FLAG_LOCK_READONLY: GstMiniObjectFlags = GstMiniObjectFlags::LOCK_READONLY;
pub const GST_MINI_OBJECT_FLAG_MAY_BE_LEAKED: GstMiniObjectFlags = GstMiniObjectFlags::MAY_BE_LEAKED;
pub const GST_MINI_OBJECT_FLAG_LAST: GstMiniObjectFlags = GstMiniObjectFlags::LAST;
...
pub const GST_OBJECT_FLAG_MAY_BE_LEAKED: GstObjectFlags = GstObjectFlags::MAY_BE_LEAKED;
pub const GST_OBJECT_FLAG_LAST: GstObjectFlags = GstObjectFlags::LAST;
...
pub const GST_PAD_FLAG_BLOCKED: GstPadFlags = GstPadFlags::BLOCKED;
pub const GST_PAD_FLAG_FLUSHING: GstPadFlags = GstPadFlags::FLUSHING;
pub const GST_PAD_FLAG_EOS: GstPadFlags = GstPadFlags::EOS;
pub const GST_PAD_FLAG_BLOCKING: GstPadFlags = GstPadFlags::BLOCKING;
pub const GST_PAD_FLAG_NEED_PARENT: GstPadFlags = GstPadFlags::NEED_PARENT;
pub const GST_PAD_FLAG_NEED_RECONFIGURE: GstPadFlags = GstPadFlags::NEED_RECONFIGURE;
pub const GST_PAD_FLAG_PENDING_EVENTS: GstPadFlags = GstPadFlags::PENDING_EVENTS;
pub const GST_PAD_FLAG_FIXED_CAPS: GstPadFlags = GstPadFlags::FIXED_CAPS;
pub const GST_PAD_FLAG_PROXY_CAPS: GstPadFlags = GstPadFlags::PROXY_CAPS;
pub const GST_PAD_FLAG_PROXY_ALLOCATION: GstPadFlags = GstPadFlags::PROXY_ALLOCATION;
pub const GST_PAD_FLAG_PROXY_SCHEDULING: GstPadFlags = GstPadFlags::PROXY_SCHEDULING;
pub const GST_PAD_FLAG_ACCEPT_INTERSECT: GstPadFlags = GstPadFlags::ACCEPT_INTERSECT;
pub const GST_PAD_FLAG_ACCEPT_TEMPLATE: GstPadFlags = GstPadFlags::ACCEPT_TEMPLATE;
pub const GST_PAD_FLAG_LAST: GstPadFlags = GstPadFlags::LAST;
...
pub const GST_PAD_LINK_CHECK_NOTHING: GstPadLinkCheck = GstPadLinkCheck::NOTHING;
pub const GST_PAD_LINK_CHECK_HIERARCHY: GstPadLinkCheck = GstPadLinkCheck::HIERARCHY;
pub const GST_PAD_LINK_CHECK_TEMPLATE_CAPS: GstPadLinkCheck = GstPadLinkCheck::TEMPLATE_CAPS;
pub const GST_PAD_LINK_CHECK_CAPS: GstPadLinkCheck = GstPadLinkCheck::CAPS;
pub const GST_PAD_LINK_CHECK_NO_RECONFIGURE: GstPadLinkCheck = GstPadLinkCheck::NO_RECONFIGURE;
pub const GST_PAD_LINK_CHECK_DEFAULT: GstPadLinkCheck = GstPadLinkCheck::DEFAULT;
...
pub const GST_PAD_PROBE_TYPE_INVALID: GstPadProbeType = GstPadProbeType::INVALID;
pub const GST_PAD_PROBE_TYPE_IDLE: GstPadProbeType = GstPadProbeType::IDLE;
pub const GST_PAD_PROBE_TYPE_BLOCK: GstPadProbeType = GstPadProbeType::BLOCK;
pub const GST_PAD_PROBE_TYPE_BUFFER: GstPadProbeType = GstPadProbeType::BUFFER;
pub const GST_PAD_PROBE_TYPE_BUFFER_LIST: GstPadProbeType = GstPadProbeType::BUFFER_LIST;
pub const GST_PAD_PROBE_TYPE_EVENT_DOWNSTREAM: GstPadProbeType = GstPadProbeType::EVENT_DOWNSTREAM;
pub const GST_PAD_PROBE_TYPE_EVENT_UPSTREAM: GstPadProbeType = GstPadProbeType::DATA_UPSTREAM;
pub const GST_PAD_PROBE_TYPE_EVENT_FLUSH: GstPadProbeType = GstPadProbeType::EVENT_FLUSH;
pub const GST_PAD_PROBE_TYPE_QUERY_DOWNSTREAM: GstPadProbeType = GstPadProbeType::QUERY_DOWNSTREAM;
pub const GST_PAD_PROBE_TYPE_QUERY_UPSTREAM: GstPadProbeType = GstPadProbeType::QUERY_UPSTREAM;
pub const GST_PAD_PROBE_TYPE_PUSH: GstPadProbeType = GstPadProbeType::PUSH;
pub const GST_PAD_PROBE_TYPE_PULL: GstPadProbeType = GstPadProbeType::PULL;
pub const GST_PAD_PROBE_TYPE_BLOCKING: GstPadProbeType = GstPadProbeType::BLOCKING;
pub const GST_PAD_PROBE_TYPE_DATA_DOWNSTREAM: GstPadProbeType = GstPadProbeType::DATA_DOWNSTREAM;
pub const GST_PAD_PROBE_TYPE_DATA_UPSTREAM: GstPadProbeType = GstPadProbeType::DATA_UPSTREAM;
pub const GST_PAD_PROBE_TYPE_DATA_BOTH: GstPadProbeType = GstPadProbeType::DATA_BOTH;
pub const GST_PAD_PROBE_TYPE_BLOCK_DOWNSTREAM: GstPadProbeType = GstPadProbeType::BLOCK_DOWNSTREAM;
pub const GST_PAD_PROBE_TYPE_BLOCK_UPSTREAM: GstPadProbeType = GstPadProbeType::BLOCK_UPSTREAM;
pub const GST_PAD_PROBE_TYPE_EVENT_BOTH: GstPadProbeType = GstPadProbeType::EVENT_BOTH;
pub const GST_PAD_PROBE_TYPE_QUERY_BOTH: GstPadProbeType = GstPadProbeType::QUERY_BOTH;
pub const GST_PAD_PROBE_TYPE_ALL_BOTH: GstPadProbeType = GstPadProbeType::ALL_BOTH;
pub const GST_PAD_PROBE_TYPE_SCHEDULING: GstPadProbeType = GstPadProbeType::SCHEDULING;
...
pub const GST_PAD_TEMPLATE_FLAG_LAST: GstPadTemplateFlags = GstPadTemplateFlags::LAST;
...
pub const GST_PARSE_FLAG_NONE: GstParseFlags = GstParseFlags::NONE;
pub const GST_PARSE_FLAG_FATAL_ERRORS: GstParseFlags = GstParseFlags::FATAL_ERRORS;
pub const GST_PARSE_FLAG_NO_SINGLE_ELEMENT_BINS: GstParseFlags = GstParseFlags::NO_SINGLE_ELEMENT_BINS;
pub const GST_PARSE_FLAG_PLACE_IN_BIN: GstParseFlags = GstParseFlags::PLACE_IN_BIN;
...
pub const GST_PIPELINE_FLAG_FIXED_CLOCK: GstPipelineFlags = GstPipelineFlags::FIXED_CLOCK;
pub const GST_PIPELINE_FLAG_LAST: GstPipelineFlags = GstPipelineFlags::LAST;
...
pub const GST_PLUGIN_DEPENDENCY_FLAG_NONE: GstPluginDependencyFlags = GstPluginDependencyFlags::NONE;
pub const GST_PLUGIN_DEPENDENCY_FLAG_RECURSE: GstPluginDependencyFlags = GstPluginDependencyFlags::RECURSE;
pub const GST_PLUGIN_DEPENDENCY_FLAG_PATHS_ARE_DEFAULT_ONLY: GstPluginDependencyFlags = GstPluginDependencyFlags::PATHS_ARE_DEFAULT_ONLY;
pub const GST_PLUGIN_DEPENDENCY_FLAG_FILE_NAME_IS_SUFFIX: GstPluginDependencyFlags = GstPluginDependencyFlags::FILE_NAME_IS_SUFFIX;
pub const GST_PLUGIN_DEPENDENCY_FLAG_FILE_NAME_IS_PREFIX: GstPluginDependencyFlags = GstPluginDependencyFlags::FILE_NAME_IS_PREFIX;
pub const GST_PLUGIN_DEPENDENCY_FLAG_PATHS_ARE_RELATIVE_TO_EXE: GstPluginDependencyFlags = GstPluginDependencyFlags::PATHS_ARE_RELATIVE_TO_EXE;
...
pub const GST_PLUGIN_FLAG_CACHED: GstPluginFlags = GstPluginFlags::CACHED;
pub const GST_PLUGIN_FLAG_BLACKLISTED: GstPluginFlags = GstPluginFlags::BLACKLISTED;
...
pub const GST_QUERY_TYPE_UPSTREAM: GstQueryTypeFlags = GstQueryTypeFlags::UPSTREAM;
pub const GST_QUERY_TYPE_DOWNSTREAM: GstQueryTypeFlags = GstQueryTypeFlags::DOWNSTREAM;
pub const GST_QUERY_TYPE_SERIALIZED: GstQueryTypeFlags = GstQueryTypeFlags::SERIALIZED;
...
pub const GST_SCHEDULING_FLAG_SEEKABLE: GstSchedulingFlags = GstSchedulingFlags::SEEKABLE;
pub const GST_SCHEDULING_FLAG_SEQUENTIAL: GstSchedulingFlags = GstSchedulingFlags::SEQUENTIAL;
pub const GST_SCHEDULING_FLAG_BANDWIDTH_LIMITED: GstSchedulingFlags = GstSchedulingFlags::BANDWIDTH_LIMITED;
...
pub const GST_SEEK_FLAG_NONE: GstSeekFlags = GstSeekFlags::NONE;
pub const GST_SEEK_FLAG_FLUSH: GstSeekFlags = GstSeekFlags::FLUSH;
pub const GST_SEEK_FLAG_ACCURATE: GstSeekFlags = GstSeekFlags::ACCURATE;
pub const GST_SEEK_FLAG_KEY_UNIT: GstSeekFlags = GstSeekFlags::KEY_UNIT;
pub const GST_SEEK_FLAG_SEGMENT: GstSeekFlags = GstSeekFlags::SEGMENT;
pub const GST_SEEK_FLAG_TRICKMODE: GstSeekFlags = GstSeekFlags::SKIP;
pub const GST_SEEK_FLAG_SKIP: GstSeekFlags = GstSeekFlags::SKIP;
pub const GST_SEEK_FLAG_SNAP_BEFORE: GstSeekFlags = GstSeekFlags::SNAP_BEFORE;
pub const GST_SEEK_FLAG_SNAP_AFTER: GstSeekFlags = GstSeekFlags::SNAP_AFTER;
pub const GST_SEEK_FLAG_SNAP_NEAREST: GstSeekFlags = GstSeekFlags::SNAP_NEAREST;
pub const GST_SEEK_FLAG_TRICKMODE_KEY_UNITS: GstSeekFlags = GstSeekFlags::TRICKMODE_KEY_UNITS;
pub const GST_SEEK_FLAG_TRICKMODE_NO_AUDIO: GstSeekFlags = GstSeekFlags::TRICKMODE_NO_AUDIO;
...
pub const GST_SEGMENT_FLAG_NONE: GstSegmentFlags = GstSegmentFlags::NONE;
pub const GST_SEGMENT_FLAG_RESET: GstSegmentFlags = GstSegmentFlags::RESET;
pub const GST_SEGMENT_FLAG_TRICKMODE: GstSegmentFlags = GstSegmentFlags::SKIP;
pub const GST_SEGMENT_FLAG_SKIP: GstSegmentFlags = GstSegmentFlags::SKIP;
pub const GST_SEGMENT_FLAG_SEGMENT: GstSegmentFlags = GstSegmentFlags::SEGMENT;
pub const GST_SEGMENT_FLAG_TRICKMODE_KEY_UNITS: GstSegmentFlags = GstSegmentFlags::TRICKMODE_KEY_UNITS;
pub const GST_SEGMENT_FLAG_TRICKMODE_NO_AUDIO: GstSegmentFlags = GstSegmentFlags::TRICKMODE_NO_AUDIO;
...
pub const GST_STACK_TRACE_SHOW_FULL: GstStackTraceFlags = GstStackTraceFlags::FULL;
...
pub const GST_STREAM_FLAG_NONE: GstStreamFlags = GstStreamFlags::NONE;
pub const GST_STREAM_FLAG_SPARSE: GstStreamFlags = GstStreamFlags::SPARSE;
pub const GST_STREAM_FLAG_SELECT: GstStreamFlags = GstStreamFlags::SELECT;
pub const GST_STREAM_FLAG_UNSELECT: GstStreamFlags = GstStreamFlags::UNSELECT;
...
pub const GST_STREAM_TYPE_UNKNOWN: GstStreamType = GstStreamType::UNKNOWN;
pub const GST_STREAM_TYPE_AUDIO: GstStreamType = GstStreamType::AUDIO;
pub const GST_STREAM_TYPE_VIDEO: GstStreamType = GstStreamType::VIDEO;
pub const GST_STREAM_TYPE_CONTAINER: GstStreamType = GstStreamType::CONTAINER;
pub const GST_STREAM_TYPE_TEXT: GstStreamType = GstStreamType::TEXT;
...
pub const GST_TRACER_VALUE_FLAGS_NONE: GstTracerValueFlags = GstTracerValueFlags::NONE;
pub const GST_TRACER_VALUE_FLAGS_OPTIONAL: GstTracerValueFlags = GstTracerValueFlags::OPTIONAL;
pub const GST_TRACER_VALUE_FLAGS_AGGREGATED: GstTracerValueFlags = GstTracerValueFlags::AGGREGATED;
